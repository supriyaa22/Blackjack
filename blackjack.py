...
# Consider making a Card class where each Card object has a suit and a rank, then a Deck class to hold all 52 Card objects, 
# and can be shuffled, and finally a Hand class that holds those Cards that have been dealt to each player from the Deck.
...
# So long as the Card class definition appears in our code, we can build Card objects inside 
# our Deck __init__ method.
class Deck:
